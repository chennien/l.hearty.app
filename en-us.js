...
_h$["m"] = _h$["m"] || {
	...
	menu: [
		"Verse of the Day", "Alice's Guestbook", "Post Feed", "My Journal", "Images", "Upgrade", "Tutorials", "About", "Sign out", "for Windows", "for macOS", "Mobile App", "Language 語言", "Rate us 5 stars", "🐞 Debug"
	]
};
...
_h$["i"] = _h$["i"] || {
	...
	signin: [
		...
		"$user is deleted or suspended due to policy violations", 
		"Wrong password", 
	...
	slogan: [
		...
		"Join 100,000+ happy users | 4.9 Star Rating", "Your connection is secure and encrypted using TLS 1.3."
	], 
	scroll: "Scroll down", 
...
_h$["e"] = _h$["e"] || {
	...
	privacy: [
		...
		"It will be public after approval. Please be patient and check again later.", 
		"It will be posted to the public feed after approval. Please be patient and check again later."
	], 
	publish: [
	...
	subject: ["Untitled, $date", "Post Title", 'New title "$title"', "Update"], 
	archive: [
	...
	picture: [
		...
		"Upload", 
		"Select again", 
		"You can upload up to 8 photos in each post.", 
	...
	penpal: [
		"Penpal", "Invite someone", "No penpal invited", "Share this with: ", "Report abuse"
	], 
	qa: [
	...
	tool: [
		"Save", "New post", "Remove", "Share", "Save as an image", "Next post", "Fullscreen", "Open book", "Flip book"
	], 
	stickerbook: [
		"All stickers", "Recent"
	], 
	...
	tutorial: [
		"//i.hearty.app/b/images/tutorials/en/m1.jpg?o=1", 
		"//i.hearty.app/b/images/tutorials/en/m2.jpg?o=1", 
		"//i.hearty.app/b/images/tutorials/en/m3.jpg?o=1", 
		"//i.hearty.app/b/images/tutorials/en/m4.jpg?o=1", 
		"//i.hearty.app/b/images/tutorials/en/d1.jpg?o=1", 
		"//i.hearty.app/b/images/tutorials/en/d2.jpg?o=1", 
		"//i.hearty.app/b/images/tutorials/en/d3.jpg?o=1", 
		"//i.hearty.app/b/images/tutorials/en/d4.jpg?o=1"
	]
};
...
_h$["p"] = _h$["p"] || {
	...
	feat_vip: [
		...
		"2FA Passcode Lock", 
		"Easy to Search, Export to TXT & Save as Images"
	], 
	remark: [
...
_h$["A"] = _h$["A"] || {
	...
	comment_ban: ["As a reminder, please follow the ", "Public Post Rules."], 
...
_h$["a"] = _h$["a"] || {
	...
	id: "Hearty ID：", 
	id_edit: "Request ID change", 
	id_public: "Hearty ID and nickname are public on the feed and the guestboard.", 
	...
	suspend: ["Not using your Hearty account any longer?<br>You'll not able to sign up with this Hearty ID as well as your account email after account deletion. ALL YOUR DATA WILL BE WIPED. (can't be undone)", "Or click <u>here</u> to change your ID", "DELETE ACCOUNT PERMANENTLY"], 
	...
	voucher_ok: 'Your code "$voucher" is redeemed successfully!', 
	voucher_invalid: "The voucher code is redeemed or invalid.", 
	voucher_vvip: [
		"VIP Loyalty Program Offer", 
	...
	fonts: [
		...
		// 以下停用
		"Jason Writing F", // 22
		"oz Caramel Writing", // 23
		"Bakudai", // 24
		"Wenhengju Wind", // 25
		"Wenhengju Fist", // 26
		"jf LihSian Writing", // 27
		"jf Oyeh Writing", // 28
		"jf Liao Writing", // 29
		"jf Drechi Writing" // 30
	]
};
...
_h$["o"] = _h$["o"] || {
	...
	plan: ["My Plan", "To change your plan, please contact us with your support PIN and Hearty ID.", '"VIP Premium (Free trial)" is a free gift for new comers.<br>No worry, you\'ll be downgraded to the free lite edition after the trial period automatically.'], 
	order: ["My Orders"], 
...
_h$["pv"] = _h$["pv"] || {
	...
	verify2: ["Not receiving verification code via SMS?", "Send a SMS message to us for manual verification. (Cellular rate may apply)", "Send", "Manual verification will be completed within 48 business hours.", "[Verify] Hearty ID："], 
...
// email
_h$["em"] = _h$["em"] || {
	title: "Opt-out Member Newsletter", 
	ask: ["We're sorry to see you go.", "Bye, opt-out."], 
	unsubscribed: '"$email" has been successfully unsubscribed from our newsletter.', 
	remarks: ["Please note, you will still receive transactional emails.", "(eg. alerts of account change & login, links of password reset and personal message notifications)"]
};
